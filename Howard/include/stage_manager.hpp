...
public:
    // Constructor
    StageManager(Motor &motor, Color_sensor *color_sensor, ServoManager *ServoManager, Distance_sensor *distance_sensor);
    ...
    void stop_and_open_grabber(uint8_t line_readings);
